...
const CustomerDetail = () => {
  ...
  const fetchOrders = async () => {
    try {
      ...
      const response = await fetch(
        `https://married-flower-fern.glitch.me/api/customers/${id}/orders?${params}`
      );
  ...
  const handleToggleBlock = async () => {
    ...
    try {
      const url = isBlocked
        ? `https://married-flower-fern.glitch.me/api/customers/${id}/unblock`
        : `https://married-flower-fern.glitch.me/api/customers/${id}`;
  ...
  const handleAddNote = async () => {
    ...
    try {
      const response = await fetch(
        `https://married-flower-fern.glitch.me/api/customers/${id}/notes`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div>
                      ...
                      <span className="font-semibold ml-1">
                        {formatCurrency(
                          customer.statistics?.spending?.year2023
                        )}
                      </span>
                    </div>
                    <div>
                      ...
                      <span className="font-semibold ml-1">
                        {formatCurrency(
                          customer.statistics?.spending?.year2024
                        )}
                      </span>
                    </div>
                    <div className="col-span-2">
                      ...
                      <span className="font-semibold ml-1">
                        {formatCurrency(
                          customer.statistics?.spending?.lifetime
                        )}
                      </span>
                    </div>
                  </div>
